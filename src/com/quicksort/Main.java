...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("bobo.quicksort.MergeSort", arr1);
        SortTestHelper.testSort("bobo.quicksort.QuickSort2Ways", arr2);
        SortTestHelper.testSort("bobo.quicksort.QuickSort3Ways", arr3);
